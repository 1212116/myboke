    ...
    <a-card>
      ...
      <a-form-model>
        ...
        <a-form-model-item label="上传头像">
          <a-upload name="file" :action="upUrl" :headers="headers" @change="avatarChange" listType="picture">
        ...
        <a-form-model-item label="上传头像背景图">
          <a-upload name="file" :action="upUrl" :headers="headers" @change="imgChange" listType="picture">
            <a-button> <a-icon type="upload" /> 点击上传 </a-button>
          </a-upload>
          <br />
        ...
        <a-form-model-item>
          <a-button type="primary" @click="updateProfile">更新</a-button>
        </a-form-model-item>
      </a-form-model>
    </a-card>
  </div>
