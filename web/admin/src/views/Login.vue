<template>
  <div class="container">
    <div class="loginBox">
      <a-form-model ref="loginFormRef" :rules="rules" :model="formdata" class="loginFrom">
    ...
    return {
      ...
      rules: {
        username: [
          ...
          { min: 5, max: 12, message: '用户名必须在5到12个字符之间', trigger: 'blur' }
        ],
        password: [
          { required: true, message: '请输入密码', trigger: 'blur' },
          { min: 5, max: 20, message: '密码必须在5到20个字符之间', trigger: 'blur' }
        ]
      }
    }
  },
